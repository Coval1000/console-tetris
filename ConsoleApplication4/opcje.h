...
void opcje(struct Sterowanie *ster, struct Graphics *graphics)
{
	...
	while (1)
	{
		...
		system("cls");
		printf("Sterowanie\n\n");
		printf("%cPrzesu\344 w g\242r\251  : %s%c\n", graphics->lewy * !(opcje.pozycja - ilosc), znakS(ster->direction.up.code), graphics->prawy * !(opcje.pozycja - ilosc));	ilosc++;
		printf("%cPrzesu\344 w d\242\210   : %s%c\n", graphics->lewy * !(opcje.pozycja - ilosc), znakS(ster->direction.down.code), graphics->prawy * !(opcje.pozycja - ilosc));	ilosc++;
		printf("%cPrzesu\344 w lewo  : %s%c\n", graphics->lewy * !(opcje.pozycja - ilosc), znakS(ster->direction.left.code), graphics->prawy * !(opcje.pozycja - ilosc));		ilosc++;
		printf("%cPrzesu\344 w prawo : %s%c\n", graphics->lewy * !(opcje.pozycja - ilosc), znakS(ster->direction.right.code), graphics->prawy * !(opcje.pozycja - ilosc));		ilosc++;
		printf("%cPauza		 : %s%c\n", graphics->lewy * !(opcje.pozycja - ilosc), znakS(ster->pauza.code), graphics->prawy * !(opcje.pozycja - ilosc));				ilosc++;
		printf("%cZapisz gr\251	 : %s%c\n", graphics->lewy * !(opcje.pozycja - ilosc), znakS(ster->zapis.code), graphics->prawy * !(opcje.pozycja - ilosc));			ilosc++;
		printf("%cWczytaj gr\251	 : %s%c\n", graphics->lewy * !(opcje.pozycja - ilosc), znakS(ster->wczytanie.code), graphics->prawy * !(opcje.pozycja - ilosc)); ilosc++;
		printf("%cNiestandardowa gra	 : %s%c\n", graphics->lewy * !(opcje.pozycja - ilosc), znakS(ster->nowy.code), graphics->prawy * !(opcje.pozycja - ilosc)); ilosc++;
		...
		printf("%cT\210o		 : %c%c\n", graphics->lewy * !(opcje.pozycja - ilosc), graphics->background, graphics->prawy * !(opcje.pozycja - ilosc));			ilosc++;
		...
		case '\r':
			...
			case 10:
				graphics->background = wyglad(graphics->background);
				break;
